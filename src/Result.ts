import { IFavicon, IMods, IMotd, IPlayers, IRawResult, IResult, IText, IVersion } from './interfaces/mod.ts';
...
export class Result {
    ...
    private getFavicon(): IFavicon {
        return {
            ...
            data: this.result?.favicon ? decode(this.result.favicon.replace('data:image/png;base64,', '')) : null,
        };
    }
